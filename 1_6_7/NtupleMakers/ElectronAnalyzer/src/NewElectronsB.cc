...
void NewElectronsB::R9_25_gsf(const Event & event, const reco::PixelMatchGsfElectron* e,
...
/*
void NewElectronsB::R9_25_ctf(const Event & event, const reco::GlobalCtfElectron* e,
                             float& eseed, float& e3x3, float& e5x5, float& spp, float& see) {
