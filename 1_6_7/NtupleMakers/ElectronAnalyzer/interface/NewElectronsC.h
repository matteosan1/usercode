#ifndef NewElectronsC_H
#define NewElectronsC_H
...
class NewElectronsC: public edm::EDAnalyzer {
public:

  NewElectronsC(const edm::ParameterSet& pset);

  virtual ~NewElectronsC();
 ...
 private:
  ...
  int run, id;
  float mc1_dr, mc_dr;
  float mc1_pt, mc1_eta, mc1_phi, mc1_e;
