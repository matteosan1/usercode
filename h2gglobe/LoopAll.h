...
// CiC inputs
Float_t pho_phiwidth[MAX_PHOTONS];
...
void Branch_pho_s4ratio(TTree * tree) { tree->Branch("pho_s4ratio", &pho_s4ratio, "pho_s4ratio[pho_n]/F"); }; 
void Branch_pho_phiwidth(TTree * tree) { tree->Branch("pho_phiwidth", &pho_phiwidth, "pho_phiwdith[pho_n]/F"); }; 
...
void SetBranchAddress_pho_s4ratio(TTree * tree) { tree->SetBranchAddress("pho_s4ratio", &pho_s4ratio, &b_pho_s4ratio); }; 
void SetBranchAddress_pho_phiwidth(TTree * tree) { tree->SetBranchAddress("pho_phiwidth", &pho_phiwidth, &b_pho_phiwidth); }; 
